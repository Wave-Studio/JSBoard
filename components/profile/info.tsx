			...
			<>
				...
				<div className="space-y-8">
					<div>
						...
						<p
							className="text-gray-200 text-sm px-1 bg-theme-primary inline-flex rounded font-medium"
						>
							{props.rank}
						</p>
					</div>
				...
				>
					Report this user to the forums admins. Please make sure
					you've thoroughly read the forums rules before reporting a
					user
				</p>
