  ...
  const [link, setLink] = useState(false);
	...
	return (
            ...
            {/*Make basic info adrea for main page*/}
                ...
                <div className="flex w-full select-none ">
                  <label onChange={() => (setWebsite(!website), setWebsiteOpen(false))}>
                    Website
                    <input
                      type="checkbox"
                      className="rounded-full ml-2"
          ...
          <div className="flex-grow rounded-md shadow-md bg-coolGray-800 p-5 my-10 text-gray-200">
            ...
            <div className="flex flex-col max-w-xl space-y-3 font-medium">
              ...
              <div className="space-y-3 flex flex-col"> {/*Div to show/hide mysql stuff*/}
                <label>
                  MongoDB URL
                  <input
                    type="text"
              ...
              <span className="font-normal">//add some backend kode here b|0ck$</span>
						</div>
					</div>
				</> 
		)
