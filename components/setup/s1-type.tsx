	...
	return (
				<>
						<div className="flex-grow rounded-md shadow-md bg-coolGray-800 p-5 my-10 text-gray-200">
								...
								<div className="flex flex-wrap max-w-xl justify-center sm:justify-start items-center gap-10">
									<label className="expand relative select-none bg-gradient-to-br from-pink-500 to-red-600 hover:from-pink-600 rounded-lg h-40 w-40 flex flex-col justify-center items-center font-medium text-gray-300 cursor-pointer opacity-70 hover:opacity-90">
										Community Forum
											<input
													type="radio"
													name="forumType"
									...
									<label className="expand relative select-none bg-gradient-to-br from-green-500  via-green-600 to-blue-900 hover:from-green-600 hover:via-green-600 rounded-lg h-40 w-40 flex flex-col justify-center items-center font-medium text-gray-300 cursor-pointer opacity-70 hover:opacity-90">
										Minecraft Forum
											<input
													type="radio"
													name="forumType"
