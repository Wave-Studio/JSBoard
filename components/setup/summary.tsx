			...
			>
				...
				<label className="flex items-center">
					<input
						type="checkbox"
						readOnly={true}
						className="rounded-full focus:checked:ring-0 focus:checked:ring-offset-transparent hover:checked:ring"
						checked
					/>
					<span className="font-medium ml-2">
						{props.name}'s {props.forumType} Forum
					</span>
				</label>
				<label className="flex items-center">
					<input
				...
				<label className="flex items-center">
					...
					/>
					<span className="font-medium ml-2">
						{props.theme} Theme with {props.accentColor} Accents
					</span>
				</label>
			</div>
		</>
