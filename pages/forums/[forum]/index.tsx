          ...
          <div className="max-w-screen-xl mx-auto py-4">
            ...
            <div className="bg-coolGray-800 rounded-md p-5 text-gray-200">
              <div className="flex flex-col md:flex-row justify-between">
                <div>
                  ...
                  <h1 className="text-2xl font-medium mt-3 ">{forum.data.name}</h1>
            ...
            <div className="space-y-3 my-10">
              ...
              forum.data.posts.map((post: OutputForumTypings) => (
                <Link href={`/post/${post.title.replaceAll(" ", "-").substring(0, 42)}:${post.id}`}>
                  <a>
                    <section className="bg-coolGray-800 px-5 py-3 mt-3 rounded-md flex hover:filter hover:brightness-90 transition cursor-pointer select-none text-gray-200 font-medium tracking-wide">
                        ...
                        <div>
                          <div className="flex items-center">
                            <figure>
                              <Image
                                ...
                                height={28}
                                src={
                                  "/pfps/" + post.authorID + post.authorPFPFormat
                                }
                                className="rounded-full"
                                alt="User Icon"
                              />
                            </figure>
                            <figcaption className="ml-2">{post.author}</figcaption>
                          </div>
                          <article className="my-3">
                            ...
                            <div className="text-xs font-thin mt-2">
                              Posted <time>{post.postDate}</time> &#8226; Updated{" "}
                      ...
                      <div className="ml-auto space-y-2">
                        <div className="inline-flex space-x-2 ">
                          <div className={" bg-coolGray-900 bg-opacity-70 rounded-md px-2 py-1 has-tooltip " + post.locked}>
                          ...
                          <div className={" bg-coolGray-900 bg-opacity-70 rounded-md px-2 py-1 has-tooltip " + post.pinned}>
