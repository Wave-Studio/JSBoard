			...
			<>
				<div className="flex flex-col min-h-screen bg-coolGray-700">
					...
					<div className="flex-1 p-2">
						<div
							className="max-w-screen-xl mx-auto text-gray-200 bg-coolGray-800 p-5 my-10 rounded-md flex flex-col md:flex-row justify-between"
						>
							<div>
							...
							<div>
								...
								<div
									className="rounded-md flex flex-wrap p-1.5 dark:bg-coolGray-75 bg-coolGray-850 gap-2 font-semibold mt-4"
								>
									<h1
		...
		<>
			<div className="flex flex-col min-h-screen bg-coolGray-700">
				...
				<div className="flex-1 p-2 px-36 gf:px-2">
					...
					<div
						className="max-w-screen-xl mx-auto text-gray-200 mb-10"
					>
						<LoadUserProfiles />
					</div>
				</div>
					...
					return (
						<>
							<Link href={"/profile/" + d}>
								<a>
									<div
										className="bg-coolGray-800 px-5 py-3 mt-3 rounded-md flex hover:filter hover:brightness-90 transition cursor-pointer select-none"
									>
										<Image
											src={user.pfp}
											width={50}
										...
										<div className="ml-5">
											<h2 className="font-medium flex">
												{user.username}{" "}
												<div
													className="rounded-sm bg-blue-600 px-1 font-semibold text-sm ml-3 mb-auto"
												>
													{user.rank}
												</div>
											</h2>
		...
		<div className="max-w-screen-xl mx-auto text-gray-200 mb-10">
			...
			>
				...
				<div className="ml-5">
					<h2 className="font-medium flex">
						<div
							className="animate-pulse mb-3 bg-blue-500 w-36 h-6 rounded"
						/>
						<div
							className="rounded-sm bg-blue-600 px-1 font-semibold text-sm ml-3 mb-auto"
						>
					...
					<p className="font-extralight">
						<div
							className="animate-pulse bg-blue-500 h-4 rounded"
						/>
					</p>
				</div>
